...
const AirdropCard = () => {
  ...
  const airdropped = (airdrop as any)?.[1] === true;
  const airdroppable = (airdrop as any)?.[0] > 0n;
    ...
    <div className="bg-white dark:bg-[#212429] shadow-[#00000003_0_0_1px,#0000000a_0_4px_8px,#0000000a_0_16px_24px,#00000003_0_24px_32px] rounded-[30px] p-4 w-11/12 max-w-[420px] min-w-[320px] relative">
      ...
      {airdropped && (
        <AirdropInfo
          ...
          value={airdropped ? (airdrop as any)?.[0] : 0n}
          symbol="MOOND"
          icon={
            <>
              <Image
      ...
      <Counter
        ...
        className="mt-6"
      />
      <div className="text-[#565a69] dark:text-[#c3c5cb] text-center text-[10px] mt-6">
        * Join our Telegram channel and ask for ETH gas fees if needed
      </div>
      <button
